...
export default function BoiledLogo({ size = 'sm' }: BoiledLogoProps) {
  if (size === 'lg') {
    return (
      <div className="flex flex-col items-center leading-none gap-1">
        <span style={{ fontFamily: oswald, fontWeight: 700, fontSize: '96px', color: '#fff', lineHeight: 1, letterSpacing: '-1px' }}>
          BOILED
        </span>
        <span style={{ fontFamily: oswald, fontWeight: 600, fontSize: '20px', color: '#fff', lineHeight: 1 }}>
          The University of Tokyo Dance Circle
        </span>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col items-center leading-none gap-[3px]">
      <span style={{ fontFamily: oswald, fontWeight: 700, fontSize: '22px', color: '#fff', lineHeight: 1, letterSpacing: '-0.5px' }}>
        BOILED
      </span>
